            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item text-light" href="#">Establecer tarifa</a>
                        </li>
                    </ul>
                </li>
            </ul>
            <a class="nav-link active mx-3" href="?pid=<?php echo base64_encode("presentacion/sesionPaseador.php") ?>">
                Usuario <i class="fa-regular fa-user"></i>
            </a>
